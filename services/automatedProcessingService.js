...
const WORKER_PATH = path.join(__dirname, "..", "workers", "automatedFileWorker.js");
...
const processSingleFile = async (
  ...
  try {
    ...
    // --- DECISION DE DESTINO: SOLO POR STATUS ---
    // Si el job termino "completed" -> PROCESSED; cualquier otro -> FAILED.
